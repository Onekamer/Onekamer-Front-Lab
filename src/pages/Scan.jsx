...
const Scan = () => {
  ...
  const [cameraSupported, setCameraSupported] = useState(() => {
    // Feature detection for BarcodeDetector with QR support
    try {
  ...
  // No ZXing fallback to avoid extra deps; manual input remains available when not supported.
